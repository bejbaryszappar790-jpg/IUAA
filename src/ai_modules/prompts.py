...
Выводи финальный результат СТРОГО на русском языке. 
Использование английского (English) или китайского (中文) языков в финальном ответе ЗАПРЕЩЕНО. 
Если ты думаешь на другом языке, обязательно переведи итог на русский.
"""